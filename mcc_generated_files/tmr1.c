...
void TMR1_Initialize(void) {
    ...
    //T1OSCEN disabled; nT1SYNC synchronize; T1CKPS 1:4; TMR1CS FOSC/4; TMR1ON disabled; 
    T1CON = 0x20;

    //T1GVAL disabled; T1GSPM enabled; T1GSS T1G; T1GTM disabled; T1GPOL high; T1GGO_nDONE done; TMR1GE enabled; 
    T1GCON = 0xD0;
