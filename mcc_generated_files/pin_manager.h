...
#define SERVO_TRIS               TRISC2
#define SERVO_LAT                LATC2
#define SERVO_PORT               RC2
#define SERVO_WPU                WPUC2
#define SERVO_ANS                ANSC2
#define SERVO_SetHigh()    do { LATC2 = 1; } while(0)
#define SERVO_SetLow()   do { LATC2 = 0; } while(0)
#define SERVO_Toggle()   do { LATC2 = ~LATC2; } while(0)
#define SERVO_GetValue()         RC2
#define SERVO_SetDigitalInput()    do { TRISC2 = 1; } while(0)
#define SERVO_SetDigitalOutput()   do { TRISC2 = 0; } while(0)

#define SERVO_SetPullup()    do { WPUC2 = 1; } while(0)
#define SERVO_ResetPullup()   do { WPUC2 = 0; } while(0)
#define SERVO_SetAnalogMode()   do { ANSC2 = 1; } while(0)
#define SERVO_SetDigitalMode()   do { ANSC2 = 0; } while(0)
...
// get/set T1G aliases
#define T1G_TRIS               TRISC6
#define T1G_LAT                LATC6
#define T1G_PORT               RC6
#define T1G_WPU                WPUC6
#define T1G_ANS                ANSC6
#define T1G_SetHigh()    do { LATC6 = 1; } while(0)
#define T1G_SetLow()   do { LATC6 = 0; } while(0)
#define T1G_Toggle()   do { LATC6 = ~LATC6; } while(0)
#define T1G_GetValue()         RC6
#define T1G_SetDigitalInput()    do { TRISC6 = 1; } while(0)
#define T1G_SetDigitalOutput()   do { TRISC6 = 0; } while(0)

#define T1G_SetPullup()    do { WPUC6 = 1; } while(0)
#define T1G_ResetPullup()   do { WPUC6 = 0; } while(0)
#define T1G_SetAnalogMode()   do { ANSC6 = 1; } while(0)
#define T1G_SetDigitalMode()   do { ANSC6 = 0; } while(0)
// get/set SDO aliases
